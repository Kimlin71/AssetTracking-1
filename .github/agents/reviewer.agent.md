---
name: Code Reviewer
description: Reviews Asset Tracking changes against requirements, Clean Code, correctness, and student explainability without rewriting by default.
...
2. Incorrect money, date, sorting, or persistence behavior
